...
Kerberos - https://docs.microsoft.com/en-us/learn/modules/network-fundamentals-2/media/3-kerberos.svg
...
Network Security Groups (NSG) - a fundamental component of Azure security. https://docs.microsoft.com/en-us/learn/modules/network-fundamentals-2/media/4-nsg.svg Tip: Use the Azure Network Watcher service and enable NSG flow logs (saves JSON file to a storage account).
